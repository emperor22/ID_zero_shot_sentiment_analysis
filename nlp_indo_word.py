...
"""
USEFUL DICTS FOR INDONESIAN NLP

To use the dictionaries, you can use the 'replace_word_dict' function
which takes an input text and a dictionary where you can input one of the dictionaries
provided here.
"""
# from https://github.com/aliakbars/bilp

__all__ = ['abbr_map', 'stop_map', 'formal_map', 'kamus_alay_map', 'replace_text_dict']

import re

def replace_text_dict(text, dictionary): # from https://stackoverflow.com/questions/51102201/replace-a-string-using-dictionary-regex
...
# from https://github.com/nasalsabila/kamus-alay

kamus_alay_map = {'22nya': 'dua-duanya',
 'aaaaaaakkk': 'ah',
 'aaaaahhhh': 'ah',
